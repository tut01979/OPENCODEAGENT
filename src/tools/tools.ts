...
import { readEmailTool, sendEmailTool, getEmailDetailsTool, downloadAttachmentTool, markEmailAsReadTool, readSentEmailsTool, searchEmailsTool } from './gmailTools.js';
import { createEventTool, listEventsTool, getCalendarLinkTool } from './calendarTools.js';
import { uploadFileDriveTool, listDriveFilesTool, createDriveFolderTool, deleteDriveFileTool, readDriveFileTool, searchDriveFilesTool, moveDriveFileTool, updateDriveFileTool, searchDriveFolderTool } from './driveTools.js';
...
registerTool(readSentEmailsTool);
...
registerTool(moveDriveFileTool);
registerTool(updateDriveFileTool);
registerTool(searchDriveFolderTool);
...
registerTool(listMyVideosTool);
registerTool(getVideoDetailsTool);
registerTool(uploadToYouTubeTool);
registerTool(getChannelAnalyticsTool);
registerTool(listYouTubeCommentsTool);
